...
export default function ROIAnalysisPanel() {
  ...
  useEffect(() => {
    ...
    if (saved) {
      try {
        ...
        // Auto-enable ROI mode
        localStorage.setItem('roiModeActive', 'true')
      } catch (err) {
  ...
  if (lastRunMode !== null && !lastRunMode.whatIfMode) {
    return (
      <div style={{ minHeight: '100vh', backgroundColor: '#0f172a', padding: '48px' }}>
        <Card style={{ backgroundColor: 'rgba(15, 23, 42, 0.9)', border: '1px solid rgba(249, 115, 22, 0.5)' }}>
          <CardContent style={{ padding: '48px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '24px' }}>
              <TrendingUp style={{ width: '32px', height: '32px', color: '#f97316' }} />
            ...
            <div style={{
              ...
              <div>
                ...
                <p style={{ color: '#94a3b8', fontSize: '14px', lineHeight: '1.6', margin: '12px 0 0 0' }}>
                  ROI (Return on Investment) analysis requires calculations to be run in <strong>What-If Mode</strong>.
                  This mode evaluates individual management actions to calculate their financial returns and investment effectiveness.
                </p>
                <p style={{ color: '#94a3b8', fontSize: '14px', lineHeight: '1.6', marginTop: '12px' }}>
                  To view ROI analysis:
                </p>
                <ol style={{ color: '#94a3b8', fontSize: '14px', lineHeight: '1.8', marginTop: '8px', paddingLeft: '20px' }}>
                  ...
                  <li>Return here to view the ROI analysis</li>
                </ol>
              </div>
            </div>
          </CardContent>
        ...
        <Card style={{ backgroundColor: 'rgba(15, 23, 42, 0.9)', border: '1px solid rgba(249, 115, 22, 0.5)' }}>
          <CardContent style={{ padding: '32px' }}>
            ...
            <p style={{ color: '#94a3b8', fontSize: '14px' }}>
              Financial return analysis for management actions. Shows benefit/investment ratio.
            </p>
          </CardContent>
        </Card>
      </div>
